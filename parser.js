(function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c126 = "each",
        peg$c127 = { type: "literal", value: "each", description: "\"each\"" },
        peg$c128 = "else",
        peg$c129 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c130 = "equals",
        peg$c131 = { type: "literal", value: "equals", description: "\"equals\"" },
        peg$c132 = "false",
        ...
        peg$c140 = "is",
        peg$c141 = { type: "literal", value: "is", description: "\"is\"" },
        peg$c142 = "=",
        ...
        peg$c148 = "not",
        peg$c149 = { type: "literal", value: "not", description: "\"not\"" },
        peg$c150 = "return",
        peg$c151 = { type: "literal", value: "return", description: "\"return\"" },
        peg$c152 = "true",
        peg$c153 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c154 = "void",
        peg$c155 = { type: "literal", value: "void", description: "\"void\"" },
        peg$c156 = "while",
        peg$c157 = { type: "literal", value: "while", description: "\"while\"" },
        peg$c158 = "}",
        ...
        peg$c173 = function(elements, elision) {
              return {
                type:     "ArrayExpression",
                elements: elements.concat(optionalList(extractOptional(elision, 0)))
              };
            },
        peg$c174 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c175 = function(head, elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c176 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
        peg$c177 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c178 = function(properties) {
               return { type: "ObjectExpression", properties: properties };
             },
        peg$c179 = function(head, tail) {
              return buildList(head, tail, 3);
            },
        peg$c180 = function(key, value) {
              return { key: key, value: value, kind: "init" };
            },
        peg$c181 = function(id) { return [id]; },
        peg$c182 = function(head, property) {
                  return { property: property, computed: true };
                },
        peg$c183 = function(head, property) {
        ...
        peg$c185 = function(callee, args) {
                return { type: "CallExpression", callee: callee, arguments: args };
              },
        peg$c186 = function(head, args) {
                  return { type: "CallExpression", arguments: args };
                },
        peg$c187 = function(head, property) {
                  return {
                    type:     "MemberExpression",
                    property: property,
                    computed: true
        ...
        peg$c188 = function(head, property) {
                  return {
                    type:     "MemberExpression",
                    property: property,
                    computed: false
        ...
        peg$c190 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c191 = function(argument, operator) {
              return {
        ...
        peg$c196 = function(operator, argument) {
        ...
        peg$c246 = "and",
        peg$c247 = { type: "literal", value: "and", description: "\"and\"" },
        peg$c248 = "or",
        peg$c249 = { type: "literal", value: "or", description: "\"or\"" },
        peg$c250 = "?",
        peg$c251 = { type: "literal", value: "?", description: "\"?\"" },
        peg$c252 = ":",
        peg$c253 = { type: "literal", value: ":", description: "\":\"" },
        peg$c254 = function(test, consequent, alternate) {
              return {
        ...
        peg$c256 = function(left, operator, right) {
              return {
                type:     "AssignmentExpression",
                operator: operator,
                left:     left,
        ...
        peg$c282 = function(body) {
              return {
                type: "BlockStatement",
                body: optionalList(extractOptional(body, 0))
              };
            },
        peg$c283 = function(head, tail) { return buildList(head, tail, 1); },
        peg$c284 = function(declarations) {
              return {
                type:         "VariableDeclaration",
                declarations: [declarations]
              };
            },
        peg$c285 = function(id, init) {
              return {
        ...
        peg$c286 = function(test, consequent, alternate) {
              return {
                type:       "IfStatement",
                test:       test,
                consequent: consequent,
        ...
        peg$c287 = function(test, consequent) {
              return {
                type:       "IfStatement",
                test:       test,
                consequent: consequent,
        ...
        peg$c289 = function(each, list, body) {
              return {
        ...
        peg$c291 = function(argument) {
              return { type: "ReturnStatement", argument: argument };
            },
        peg$c292 = function(id, params, body) {
              return {
    ...
    function peg$parseObjectLiteral() {
      ...
      s1 = peg$parse__();
      if (s1 !== peg$FAILED) {
        s2 = peg$parsePropertyNameAndValueList();
        if (s2 !== peg$FAILED) {
          s3 = peg$parse__();
          if (s3 !== peg$FAILED) {
            peg$savedPos = s0;
    ...
    function peg$parsePropertyNameAndValueList() {
      ...
      s1 = peg$parse__();
      if (s1 !== peg$FAILED) {
        s2 = peg$parsePropertyAssignment();
        if (s2 !== peg$FAILED) {
          s3 = [];
          s4 = peg$currPos;
          s5 = peg$parse__();
          if (s5 !== peg$FAILED) {
            ...
            if (s6 !== peg$FAILED) {
              s7 = peg$parse__();
              if (s7 !== peg$FAILED) {
                s8 = peg$parsePropertyAssignment();
                if (s8 !== peg$FAILED) {
                  s5 = [s5, s6, s7, s8];
                  s4 = s5;
                } else {
    ...
    function peg$parsePropertyAssignment() {
      ...
      s1 = peg$parse__();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseHasToken();
        if (s2 !== peg$FAILED) {
          s3 = peg$parse__();
          if (s3 !== peg$FAILED) {
            s4 = peg$parsePropertyName();
            if (s4 !== peg$FAILED) {
              s5 = peg$parse__();
              if (s5 !== peg$FAILED) {
                s6 = peg$parseIsToken();
